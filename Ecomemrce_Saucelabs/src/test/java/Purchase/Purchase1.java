...
public class Purchase1 
{
	...
	public void Purchase1() throws IOException 
	{
		...
		driver.findElement(By.id("first-name")).sendKeys(eLib.getDataFromExcel("Sheet1", 2, 0),Keys.TAB,eLib.getDataFromExcel("Sheet1", 2, 1),Keys.TAB,eLib.getDataFromExcel("Sheet1", 2, 2));
